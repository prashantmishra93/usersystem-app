...
const UserAdd = (props) => {
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            const response = await makeAjax(url.CREAD_API.registerUser, data);
        ...
        <div className='card p-4'>
            <form className="row g-3" method="POST" onSubmit={(e) => handleFormSubmit(e)} enctype="multipart/form-data">
                ...
                <div className="col-md-12">
                    ...
                    <input type="text" name='email' value={formData.email} onChange={handleInputChange} className="form-control" id="inputEmail" />
                </div>
                <div className="col-6">
